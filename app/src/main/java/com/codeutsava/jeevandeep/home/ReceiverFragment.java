...
import com.codeutsava.jeevandeep.donationcampaignlist.view.DonationCampaignListFragment;
...
public class ReceiverFragment extends Fragment {
    ...
    @BindView(R.id.donationcampaign)
    CardView donationcampaign;

    @BindView(R.id.donationhistory)
    CardView donationhistory;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        donationcampaign.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((HomeActivity) getActivity()).setFragment(new DonationCampaignListFragment(),"");
            }
        });
        ...
        donationhistory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(context, "You have not made any donations yet!", Toast.LENGTH_SHORT).show();
